...
| `lifePhase` | `string` | Life phase (e.g., "student") (indexed). |
| `seekingMentorship`| `boolean` | Mentorship status. |
| `themePreference` | `"light" \| "dark" \| "system"` | User UI theme preference. |
| `pushNotificationToken` | `string` | Token for push notifications. |
