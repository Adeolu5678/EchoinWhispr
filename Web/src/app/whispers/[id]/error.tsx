...
export default function WhisperError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Whisper error boundary caught:', error);
  }, [error]);
    ...
    <div className="min-h-screen pt-20 pb-10 px-4 md:px-8 lg:px-12 flex justify-center items-center">
      <Card className="glass w-full max-w-md border-white/10">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Failed to load whisper</CardTitle>
          <CardDescription>
            We couldn&apos;t load this whisper. It may have been deleted or is no longer available.
          </CardDescription>
        </CardHeader>
