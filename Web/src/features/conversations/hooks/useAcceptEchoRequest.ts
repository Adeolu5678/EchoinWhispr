 ...
 */
export const useAcceptEchoRequest = (): { acceptEchoRequest: (requestId: GenericId<"echoRequests">) => Promise<void>, isLoading: boolean } => {
  /**
   ...
   */
  const acceptEchoRequest = useCallback(async (requestId: GenericId<"echoRequests">) => {
